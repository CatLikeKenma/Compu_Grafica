...
void SubMainLight_float(float3 PositionWS, out float3 Direction, out float3 Color, out float ShadowAttenuation)  //float -> 32 Bits, half -> 16 
{
    ...
    Light SubmainLight = GetMainLight(shadowCoord);
    Direction = SubmainLight.direction;
    Color =     SubmainLight.color;
    ShadowAttenuation = SubmainLight.shadowAttenuation;
    #endif
}
